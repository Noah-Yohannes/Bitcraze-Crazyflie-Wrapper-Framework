...
# Option 1: Providing the waypoints we would like the drone to visit manually
# Each waypoint's format is : ( x-coordinate, y-coordinate, z-coordinate/elevation, velocity )
mission_coordinates = [(1.5 , 3.0, 1.0, 0.1),
                       (2.0 , 3.0, 1.0, 0.1),
                       (2.5 , 3.0, 1.0, 0.1), 
                       (3.0 , 3.0, 1.0, 0.1), 
                       (3.5 , 3.0, 1.0, 0.1),
                       (4.0 , 3.0, 1.0, 0.1),
                       (4.0 , 3.0, 1.0, 0.1)]   # set original mission coordinate waypoints, straight flight
